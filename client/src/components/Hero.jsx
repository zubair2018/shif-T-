    ...
    <section id="top" className="relative min-h-[95vh] flex items-center">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-24 w-full">
        <div className="max-w-2xl">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/25 bg-emerald-500/8 px-4 py-2 mb-8">
          ...
          <p className="text-slate-300 text-lg md:text-xl max-w-lg mb-10 leading-relaxed font-light">
            ...
            <span className="text-slate-400">
              No broker drama. No hidden fees.
            </span>
          </p>
          ...
          <div className="flex items-center gap-8 mb-10 flex-wrap">
            {[
              ...
              <div key={stat.label} className="flex items-center gap-8">
                ...
                {i < 2 && <div className="h-8 w-px bg-slate-800" />}
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 mb-8">
            <button
              onClick={onBookClick}
              className="group px-8 py-4 rounded-full bg-yellow-400 text-slate-950 font-black text-sm hover:bg-yellow-300 transition-all shadow-[0_0_40px_rgba(250,204,21,0.45)] hover:shadow-[0_0_60px_rgba(250,204,21,0.6)] hover:scale-105 active:scale-95"
            >
              Book a Truck
            ...
            <a
              href="#how"
              className="px-8 py-4 rounded-full border border-slate-700 text-slate-300 text-sm font-medium hover:border-yellow-400/40 hover:text-yellow-300 hover:bg-yellow-400/5 transition-all"
            >
              See how it works
            </a>
          </div>
