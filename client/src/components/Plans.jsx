...
const Plans = () => {
  return (
    <section className="relative bg-slate-950 py-20 md:py-28 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_100%,rgba(250,204,21,0.04),transparent)]" />
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <div className="mb-16 max-w-2xl">
          ...
          <p className="text-slate-400 text-base md:text-lg">
            ...
            of service that fits your workload.
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`relative rounded-2xl p-7 border flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] ${
                plan.highlight
                  ? "bg-gradient-to-b from-yellow-500/10 to-yellow-500/0 border-yellow-400/30 shadow-[0_0_50px_rgba(250,204,21,0.12)]"
                  : "bg-slate-900/60 border-slate-800/80 hover:border-slate-700"
              }`}
            >
              {plan.highlight && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                  <span className="rounded-full bg-yellow-400 text-slate-950 text-[10px] font-black px-4 py-1 whitespace-nowrap shadow-[0_0_20px_rgba(250,204,21,0.5)]">
                    ⭐ Most Popular
                  </span>
                </div>
              )}
              ...
              <div>
                ...
                <p className={`text-sm font-bold mb-5 ${plan.highlight ? "text-yellow-400" : "text-slate-400"}`}>
                  {plan.price}
                </p>
              ...
              <button
                className={`mt-8 w-full rounded-full text-sm font-bold py-3 transition-all hover:scale-105 active:scale-95 ${
                  plan.highlight
                    ? "bg-yellow-400 text-slate-950 hover:bg-yellow-300 shadow-[0_0_24px_rgba(250,204,21,0.35)]"
                    : "border border-slate-700 text-slate-300 hover:border-yellow-400/40 hover:text-yellow-300 hover:bg-yellow-400/5"
                }`}
              >
                {plan.cta}
              </button>
